...
NAV2D.Navigator = function(options) {
  ...
  this.setRobotMarker = function() {
    ...
    robotMarker.visible = false;
     ...
     var children = this.rootObject.children;
     for (var i = 0; i < children.length; i++) {
       if (children[i].toString().includes("Shape")) {
         this.rootObject.removeChild(children[i]);
       }
     }
...
NAV2D.OccupancyGridClientNav = function(options) {
  ...
  this.client.on('change', function() {
    ...
    //that.viewer.scaleToDimensions(5, 5);
